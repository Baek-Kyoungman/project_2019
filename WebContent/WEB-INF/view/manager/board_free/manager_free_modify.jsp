...
<%
	...
	String chg_dt = CmmUtil.nvl(fDTO.getChg_dt());
%>
<!DOCTYPE html>
<html lang="en">
<head>
<title>[관리페이지] 자유게시물 수정</title>
					...
					<div class="notice_container">
						<div class="container-fluid">
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<form method="post" id="manager_free_modify"
										action="/manager/Manager_free_modifyProc.do">
										...
										<div class="notice_box">
											...
											<div class="table_title_box">
												<div>
													<div class="row">
														...
														<div class="col-lg-10">
															<input type="text" class="table_input_text"
																placeholder="제목을 입력해주세요( 50 자 이하 )"
											...
											<div class="notice_btn_box">
												<input type="submit" id="reg_btn"
													...
													href="/manager/board_free_detail.do?free_seq=<%=CmmUtil.nvl(fDTO.getFree_seq()) %>"
