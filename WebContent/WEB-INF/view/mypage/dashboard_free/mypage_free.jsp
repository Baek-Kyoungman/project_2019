			...
			<div class="adminx-main-content">
				<div class="container-fluid">
					...
					<div class="container table-area">
						<div class="row">
							<div class="col-md-12">
								<input type="button" onclick="location.href='/mypage/FreeReg.do'" class="btn btn-list" value="글 작성"> 
									...
									<div>
										...
										<div class="row">
											...
											<div class="col-md-4 cell-3">
												<a href="/mypage/dashboard_free_detail.do?free_seq=<%=CmmUtil.nvl(nDTO.getFree_seq())%>"><%=title%></a>
											</div>
												...
												<ul class="pagination">
													<li class="#">
														...
														%> <a href="#">&lt;</a> <%
	 													...
	 													%> <a
														href="/mypage/dashboard_free.do?pgNum=<%=pgNum - 1%>">&lt;</a>
														<% 
	 														}
	 													%>
													</li>
													...
													%>
													<li class="#"><a
														href="/mypage/dashboard_free.do?pgNum=<%=i%>"><%=i%></a></li>
													<%
														}
													%>
													<%
	...
	<script type="text/javascript">
        	...
        	function modifyDel() {
        		...
        		if (confirm("삭제하시겠습니까?") == true) {
        			document.location.href = "/mypage/freeDelete.do?free_seq=" + $("input:radio[name=chk]:checked").val();
        		} else {
        			return false;
        		}
        	}
