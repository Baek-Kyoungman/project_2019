							...
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<form method="post" id="regform"
										action="/mypage/Mypage_FreeRegProc.do">
										<div class="notice_box">
											...
											<div class="notice_btn_box">
												...
												<input type="button" class="btn btn-danger btn_list" onclick="location.href='/mypage/dashboard_free.do'" value="취소하기">
											</div>
										</div>
									</form>
								</div>
	...
	<script>
		function button_event1() {
			if (confirm("변경사항이 저장되지 않을 수 있습니다.") == true) { //확인
				location.href = "/mypage/freeDelete.do"
			} else { //취소
				return;
			}
		}
