					...
					<div class="notice_container">
						<div class="container-fluid">
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<form method="post" id="regform" action="/manager/Manager_FreeRegProc.do">
										...
										<div class="table_cont_box">
												...
												<div class="row">
													...
													<div class="col-lg-10">
														<textarea class="table_textbox" name="contents"
															id="smarteditor"
															style="width: 100%; height: 400px; padding-left: 0.5em;"></textarea>
													</div>
													<div></div>
												</div>
											</div>
											...
											<div class="notice_btn_box">
												<input type="submit" id="reg_btn"
													...
													type="button" class="btn btn-danger btn_list"
													onclick="location.href='/manager/dashboard_free.do'"
													value="취소하기">
											</div>
										</div>
									</form>
	...
	<script>
		function button_event1() {
			if (confirm("변경사항이 저장되지 않을 수 있습니다.") == true) { //확인
				location.href = "/manager/manager_freeDelete.do"
			} else { //취소
				return;
			}
		}
