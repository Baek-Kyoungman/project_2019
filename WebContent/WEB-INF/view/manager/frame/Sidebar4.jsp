            ...
            <div class="adminx-sidebar expand-hover push" id="sidebar">
                    <ul class="sidebar-nav">
                        ...
                        <li class="sidebar-nav-item">
                            ...
                            <ul class="sidebar-sub-nav collapse" id="list">
                                <li class="sidebar-nav-item">
                                ...
                                <li class="sidebar-nav-item">
                                    <a href="/manager/board_free.do" class="sidebar-nav-link">
						...
						<li class="sidebar-nav-item">
							...
							<ul class="sidebar-sub-nav collapse show" id="navKinder">
								<li class="sidebar-nav-item">
									<a href="/manager/manager_kid.do" class="sidebar-nav-link active">
                            ...
                            <ul class="sidebar-sub-nav collapse" id="navForms">
                                <li class="sidebar-nav-item">
                                    <a href="/manager/setting.do" class="sidebar-nav-link">
                                        ...
                                        <span class="sidebar-nav-name"> 내 정보 수정
                                        </span>
                                    </a>
                                </li>
                            </ul>
