...
<body>
	...
	<div class="adminx-container">
		...
		<!-- Sidebar 영역 시작 -->
		<%@include file="/WEB-INF/view/mypage/frame/Sidebar2.jsp"%>
		<!-- Sidebar 종료 -->
					...
					<div class="notice_container">
						<div class="container-fluid">
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<form method="post" id="mypage_free_modify"
										action="/mypage/Mypage_free_modifyProc.do">
										<input type="hidden" name="free_seq"
											value="<%=CmmUtil.nvl(fDTO.getFree_seq()) %>">
										<div class="notice_box">
											...
											<div class="notice_btn_box">
												<input type="submit" id="reg_btn"
													class="btn btn-primary btn_list" value="수정하기"> <a
													href="/mypage/dashboard_free_detail.do?free_seq=<%=CmmUtil.nvl(fDTO.getFree_seq()) %>"
													class="btn btn-danger btn_list">취소하기</a>
											</div>
										</div>
									</form>
								</div>
