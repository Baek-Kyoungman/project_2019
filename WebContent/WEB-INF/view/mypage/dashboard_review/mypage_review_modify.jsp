					...
					<div class="notice_container">
						<div class="container-fluid">
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<form method="post" id="mypage_review_modify"
										action="/mypage/Mypage_review_modifyProc.do">
										<input type="hidden" name="review_seq"
											value="<%=CmmUtil.nvl(fDTO.getReview_seq()) %>">
										<div class="notice_box">
														...
														<div class="col-lg-10">
															...
															<div class="tab-content" id="nav-tabContent">
																<div class="tab-pane fade show active" id="nav-places" role="tabpanel" aria-labelledby="nav-places-tab">
																	<select name="sidoCode" class="custom-select board-tab">
																		<option value="<%=CmmUtil.nvl(fDTO.getSidoCode())%>"><%=CmmUtil.nvl(fDTO.getSidoCode())%></option>
																		<option value="서울특별시">서울특별시</option>
                                                                    </select> 
                                                                    <select name="sggCode" class="custom-select board-tab">
											...
											<div class="table_title_box">
												<div>
													<div class="row">
														...
														<div class="col-lg-10">
                                                            <input type="text" class="table_input_text" placeholder="제목을 입력해주세요( 50 자 이하 )" value="<%=title%>" name="title" id="title" maxlength="50" style="width: 100%; padding-left: 0.5em;">
                                                        </div>
													</div>
												</div>
											</div>
											...
											<div class="notice_btn_box">
                                                ...
                                                <a href="/mypage/dashboard_review_detail.do?review_seq=<%=CmmUtil.nvl(fDTO.getReview_seq())%>" class="btn btn-danger btn_list">취소하기</a>
											</div>
										</div>
									</form>
								</div>
