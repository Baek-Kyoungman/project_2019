				...
				<div class="notice_container">
					<div class="container-fluid">
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<form method="post" id="regform" action="/freeModifyProc.do"
													...
													<div class="col-lg-10">
														...
														<div class="tab-content" id="nav-tabContent">
															<div class="tab-pane fade show active" id="nav-places"
																...
																<select id="sidoCode" name="sidoCode" class="custom-select"
												...
												<div class="row">
													...
													<div class="col-lg-10">
														<input type="text" class="table_input_text"
															placeholder="제목을 입력해주세요( 50 자 이하 )" name="title"
