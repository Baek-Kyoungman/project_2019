			...
			<div class="adminx-main-content">
				<div class="container-fluid">
					...
					<div class="container table-area">
						<div class="row">
							<div class="col-md-12">
								<input type="button" onclick="location.href='/manager/manager_ReviewReg.do'" class="btn btn-list" value="글 작성"> 
									...
									<div>
										...
										<div class="row">
											...
											<div class="col-md-4 cell-3">
												<a href="/manager/board_review_detail.do?review_seq=<%=CmmUtil.nvl(nDTO.getReview_seq()) %>"><%=title%></a>
											</div>
												...
												<ul class="pagination">
													<li class="#">
														...
														<%
	 													...
	 													%> 
	 														<a href="/manager/board_review.do?pgNum=<%=pgNum - 1%>">&lt;</a> 
	 													<% 
	 														}
	 													%>
													</li>
													...
													%>
													<li class="#">
														<a href="/manager/board_review.do?pgNum=<%=i%>"><%=i%></a>
													</li>
													<%
														}
													%>
	...
	<script type="text/javascript">
		function modifyDel() {
			...
			if (confirm("삭제하시겠습니까?") == true) {
				document.location.href = "/manager/manager_reviewDelete.do?review_seq="
