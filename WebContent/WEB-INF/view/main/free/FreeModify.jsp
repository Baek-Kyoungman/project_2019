...
<body>
	...
	<div class="breadcumb-area bg-img bg-overlay" style="background-image: url(/kido/img/bg-img/seoul_2.jpg)"></div>
				...
				<div class="notice_container">
					<div class="container-fluid">
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<form method="post" id="regform" action="/freeModifyProc.do" onsubmit="return !!(check()&validation());">
									...
									<div class="notice_box">
													...
													<div class="col-lg-10">
														...
														<div class="tab-content" id="nav-tabContent">
															<div class="tab-pane fade show active" id="nav-places" role="tabpanel" aria-labelledby="nav-places-tab">
																<select id="sidoCode" name="sidoCode" class="custom-select" 																	onchange="getList(this.selectedIndex)">
																	<option value="<%=CmmUtil.nvl(fDTO.getSidoCode()) %>"><%=CmmUtil.nvl(fDTO.getSidoCode()) %></option>
																	<option value="서울특별시">서울특별시</option>
																</select> 
																<select id="sggCode" name="sggCode" class="custom-select">
										...
										<div class="table_title_box">
											<div>
												<div class="row">
													...
													<div class="col-lg-10">
														<input type="text" class="table_input_text" placeholder="제목을 입력해주세요( 50 자 이하 )" name="title" id="title" maxlength="50" style="width: 100%; padding-left: 0.5em;" value='<%=title%>'>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="notice_btn_box">
											<input type="submit" id="reg_btn"
												class="btn btn-primary btn_list" value="등록하기"> <input
												type="submit" onclick="location.href='/main/FreeList.do'"
												class="btn btn-danger btn_list" value="취소하기">
										</div>
									</div>
								</form>
							</div>
