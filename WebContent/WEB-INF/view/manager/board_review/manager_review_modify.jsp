...
<body>
						...
						<div class="container-fluid">
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<h6 class="cont_title">게시글 수정</h6>
								</div>
								<div class="card-body">
									<form method="post" id="manager_review_modify" action="/manager/Manager_review_modifyProc.do">
										...
										<div class="notice_box">
																...
																<div class="tab-pane fade show active" id="nav-places" role="tabpanel" aria-labelledby="nav-places-tab">
																	<form>
																		<select name="sidoCode"
																			class="custom-select board-tab">
																			<option value="<%=CmmUtil.nvl(fDTO.getSidoCode())%>"><%=CmmUtil.nvl(fDTO.getSidoCode())%></option>
																			<option value="서울특별시">서울특별시</option>
																		</select> 
																		<select name="sggCode"
																			class="custom-select board-tab">
																			<option value="<%=CmmUtil.nvl(fDTO.getSggCode())%>"><%=CmmUtil.nvl(fDTO.getSggCode())%></option>
																		...
																		<select name="type" class="custom-select board-tab">
											...
											<div class="table_title_box">
												<div>
													<div class="row">
														...
														<div class="col-lg-10">
                                                            <input type="text" class="table_input_text" placeholder="제목을 입력해주세요( 50 자 이하 )" value="<%=CmmUtil.nvl(fDTO.getTitle()) %>" name="title" id="title" maxlength="50" style="width: 100%; padding-left: 0.5em;">
                                                        </div>
													</div>
												</div>
											</div>
											...
											<div class="table_cont_box">
												<div>
													<div class="row">
														...
														<div class="col-lg-10">
															<textarea class="table_textbox" name="contents" id="smarteditor" style="width: 100%; height: 500px; padding-left: 0.5em;"></textarea>
														</div>
													</div>
												</div>
											</divle>
											...
											<div class="notice_btn_box">
												<input type="submit" id="reg_btn" class="btn btn-primary btn_list" value="수정하기"> 
													<a href="/manager/board_review_detail.do?review_seq=<%=CmmUtil.nvl(fDTO.getReview_seq()) %>" class="btn btn-danger btn_list">
													취소하기
													</a>
											</div>
										</div>
	...
	<script type="text/javascript">
		...
		document.querySelector('#smarteditor').value='<%=CmmUtil.nvl(fDTO.getContents())%>';
		$(document).ready(
				function() {
					// Editor Setting
