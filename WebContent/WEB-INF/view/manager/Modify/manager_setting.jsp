...
<body>
	...
	<div class="adminx-container">
		...
		<!-- Sidebar 영역 시작 -->
		<%@include file="/WEB-INF/view/manager/frame/Sidebar5.jsp"%>
		<!-- Sidebar 종료 -->
				...
				<div class="row">
							...
							<div class="card-body collapse show" id="card1">
								<form>
									<div class="form-group">
										...
										<div class="form-control"><%=user_name %></div>
									</div>
									<div class="form-group">
										<label class="form-label">아이디</label>
										<div class="form-control"><%=user_id %></div>
									</div>
									<input type="button" onclick="userDel()" class="btn btn-danger btn-block" value="회원탈퇴">
								</form>
							</div>
						</div>
						<div class="card mb-grid">
							...
							<div class="card-body collapse show" id="card1">
								<form method="post" action="/manager/userPassword.do"
									onsubmit="return update_password();">
									<div class="form-group">
										<label class="form-label">새로운 비밀번호</label> 
										<input type="password" class="form-control form-margin-bottom" name="password"> 
										<label class="form-label">새로운 비밀번호 확인</label> 
										<input type="password" class="form-control form-margin-bottom" name="new_password1">
									</div>
									<input type="submit" name="update_password" class="btn btn-primary btn-block" value="비밀번호 변경">
								</form>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="card mb-grid">
							...
							<div class="card-body collapse show" id="card1">
								<form method="post" action="/manager/userEmail.do">
									<div class="form-group">
									...
									<div class="form-group">
										<label class="form-label" for="exampleInputEmail1">새로운 이메일</label> 
										<input type="email" class="form-control" name="email" value="">
									</div>
									<button type="submit" class="btn btn-primary btn-block" onclick="button_event_3();">이메일 변경</button>
								</form>
							</div>
						</div>
						<div class="card mb-grid">
							...
							<div class="card-body collapse show" id="card1">
								<form method="post" action="/manager/userJob.do">
									<div class="form-group">
	...
	<script type="text/javascript">
	    	function userDel() {
	    		if (confirm("회원탈퇴 하시겠습니까?") == true) {
	    			document.location.href = "/manager/userDelete.do?user_id="
