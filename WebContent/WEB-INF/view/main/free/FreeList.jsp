	...
	<section class="dorne-single-listing-area section-padding-30-100">
		...
		<div class="container">
			<div class="row justify-content-center" style="min-height: 540px;">
				...
				<div class="listing-reviews-area mt-50" id="review"
					style="width: 100%">
					...
					<div class="single-review-area-15 board-box-shadow">
						<div class="reviewer-meta d-flex align-items-center row">
							...
							<div class="reviewer-name col-md-3">
								<p><%=CmmUtil.nvl(fDTO.getUser_id()) %> / <%=CmmUtil.nvl(fDTO.getChg_dt().substring(2,16)) %></p>
							</div>
						</div>
					</div>
					<% } %>
					...
					<nav>
						<ul class="pagination">
							<li class="#">
								...
								%> <a href="#">&lt;</a> 
								<%} else { %> 
								<a href="/main/FreeList.do?pgNum=<%=pgNum - 1%>">&lt;</a> 
								<% } %>
							</li>
							<li class="#">
								<%
							...
							%>
							<li class="#"><a href="/main/FreeList.do?pgNum=<%=i%>"><%=i%></a></li>
							<% } %>
							<% } %>
							<% } else { %>
							<% if (pgNum < 4) { %>
