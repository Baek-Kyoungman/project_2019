				...
				<div class="notice_container">
					<div class="container-fluid">
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<form method="post" id="regform" action="/ReviewRegProc.do"
									...
									<div class="notice_box">
										...
										<div class="notice_btn_box">
											...
											<input type="submit" onclick="location.href='/main/ReviewList.do'" class="btn btn-danger btn_list" value="취소하기">
										</div>
									</div>
								</form>
							</div>
