							...
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<form method="post" id="regform"
										action="/manager/Manager_ReviewRegProc.do">
										<div class="notice_box">
														...
														<div class="col-lg-10">
															...
															<div class="tab-content" id="nav-tabContent">
																<div class="tab-pane fade show active" id="nav-places" role="tabpanel" aria-labelledby="nav-places-tab">
                                                                    ...
                                                                    <select id="sigungu" name="sggCode" class="custom-select" style="width: 150px;">
											...
											<div class="table_title_box">
												<div>
													<div class="row">
														...
														<div class="col-lg-10"><input type="text" class="table_input_text"
															placeholder="제목을 입력해주세요( 50 자 이하 )" name="title"
															id="title" maxlength="50"
															style="width: 100%; padding-left: 0.5em;"></div>
													</div>
												</div>
											</div>
											<hr class="notice_hr_inner">
											...
											<div class="notice_btn_box">
												...
												<input type="button" class="btn btn-danger btn_list" onclick="location.href='/manager/board_review.do'" value="취소하기">
											</div>
										</div>
									</form>
								</div>
	...
	<script>
		function button_event1() {
			if (confirm("변경사항이 저장되지 않을 수 있습니다.") == true) { //확인
				location.href = "/manager/reviewDelete.do"
			} else { //취소
				return;
			}
		}
